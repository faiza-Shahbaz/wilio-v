...
<?php
						...
						$message = "DETAILS\n";
						$message .= "\n1) How do you describe your overall satisfaction? ";
						$message .= "\nService provided: " . $_POST['rating_input_1'];
						$message .= "\nProduct quality : " . $_POST['rating_input_2'];
						$message .= "\nSupport: " . $_POST['rating_input_3'];
						$message .= "\nGeneral satisfaction: " . $_POST['rating_input_4']. "\n";
	
						$message .= "\n2) Your review and comments:";
						$message .= "\n" . $_POST['review_message']. "\n";
